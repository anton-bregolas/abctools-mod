...
| *Customize app context menu* | ⏱️ IN PROGRESS | Add modern CSS anchor positioning for smoother menu opening.<br>Implement menu keyboard navigation and prevent accidental scroll.<br>TO DO: ensure anchor positioning fallback logic fires in non-supporting browsers.<br>TO DO: Refactor Context Menu as a popover for mobile layout, add adaptive styles. |
