...
| ⏱️ **Enable true mobile layout for menus & editor** | Optionally use True Mobile layout setting on any device.<br>Enable fullscreen menus in True Mobile layout.<br>TO DO: Enable enlarged fonts in True Mobile layout.<br>TO DO: Enable large Editor icon-buttons in True Mobile layout. |
...
| *Customize app context menu* | ⏱️ IN PROGRESS | Add modern CSS anchor positioning for smoother menu opening.<br>Implement menu keyboard navigation and prevent accidental scroll.<br>Ensure anchor positioning fallback logic fires in non-supporting browsers.<br>Enable full screen size for mobile layout.<br>TO DO: Refactor Context Menu as a popover, add adaptive styles. |
